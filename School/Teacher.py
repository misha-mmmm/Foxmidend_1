...
# Створити метод який буде за запитом предмета виводити ім'я викладача.

# Створити метод, який буде показувати список викладачів.

# додати сортування вчителів за віком, в функціїї яка виводить список вчителів
# завтра урок, так що дз маленьке